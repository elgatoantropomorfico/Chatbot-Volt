      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          <div className="landing-nav-links" style={{ display: 'flex', alignItems: 'center', gap: 22 }}>
            ...
            <div className="landing-solutions-dropdown" style={{ position: 'relative' }}>
              <button
                type="button"
              ...
              <div
                className="landing-solutions-menu"
                style={{
                  position: 'absolute',
                  top: '100%',
                  left: 0,
          ...
          <div className="landing-nav-mobile" style={{ display: 'none', gap: 12, alignItems: 'center' }}>
            <Link href="/contacto" style={{ ...navLinkStyle, fontSize: 13 }}>
              Contacto
            </Link>
          </div>
